...
import { BackHandler, Dimensions, LayoutChangeEvent, Platform, Pressable, StyleSheet, View } from 'react-native';
import Animated, {
    Extrapolate,
    interpolate,
    useAnimatedStyle,
...
export const BottomSheet: React.FC<Props> = ({ isVisible, onClose, children }) => {
  ...
  const rSheetStyle = useAnimatedStyle(() => {
    ...
    return {
      ...
      maxHeight: Platform.OS === 'ios' ? MAX_HEIGHT - tabBarHeight : MAX_HEIGHT,
    };
  });
    ...
    <ThemedView style={styles.container}>
      ...
      <Animated.View 
        style={[
          styles.sheet, 
          rSheetStyle, 
          Platform.OS === 'ios' ? { bottom: tabBarHeight } : undefined
        ]}
      >
